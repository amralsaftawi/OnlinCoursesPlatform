        ...
        public CourseProfile()
        {
            ...
            CreateMap<Course, CourseListViewModel>()
                ...
                .ForMember(dest => dest.CurrencySymbol, opt => opt.MapFrom(src =>
                    src.Currency != null ? src.Currency.Symbol : "$"))
            ...
            CreateMap<Course, CourseDetailsViewModel>()
                ...
                .ForMember(dest => dest.CurrencyName, opt => opt.MapFrom(src =>
                    src.Currency != null ? src.Currency.Name : "Unknown"))
                .ForMember(dest => dest.CurrencySymbol, opt => opt.MapFrom(src =>
                    src.Currency != null ? src.Currency.Symbol : "$"))
                .ForMember(dest => dest.InstructorName, opt => opt.MapFrom(src =>
                    src.Instructor != null
                ...
                .ForMember(dest => dest.SectionCount, opt => opt.MapFrom(src =>
                ...
                .ForMember(dest => dest.Tags, opt => opt.MapFrom(src =>
                    src.CourseTags != null ? src.CourseTags.Select(ct => ct.Tag != null ? ct.Tag.Name : "").ToList() : new List<string>()))
                .ForMember(dest => dest.TotalLessons, opt => opt.MapFrom(src =>
                    src.Sections != null ? src.Sections.SelectMany(s => s.Lessons).Count() : 0));

            // ===== Section → SectionDetailsViewModel =====
            CreateMap<Section, SectionDetailsViewModel>();

            // ===== Lesson → LessonDetailsViewModel =====
            CreateMap<Lesson, LessonDetailsViewModel>();

            // ===== Review → ReviewDetailsViewModel =====
